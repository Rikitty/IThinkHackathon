...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      {/* <img src={imageSrc} alt="Volunteerism Image" className="image-style" /> */}
      <p>Making <b>Volunteerism</b> More Exciting</p>
      <p>Join the force to create a fun and exciting experience</p>
      <p>Increaser in <b>Action</b></p>
      <p>Welcome to your</p>
